...
RUN_NAME="mimo-scaling-gbs768-68n-ep8-PG${OVERLAP_PARAM_GATHER}-GR${OVERLAP_GRAD_REDUCE}"
...
echo "=== hetero scaling GBS=768 68n EP=8 expt_dp=64 lanes=8 (${TRAIN_ITERS} iters, PG=${OVERLAP_PARAM_GATHER} GR=${OVERLAP_GRAD_REDUCE}, force-LB=${MOE_ROUTER_FORCE_LOAD_BALANCING}) ==="
