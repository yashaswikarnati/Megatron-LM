#!/bin/bash
# Submit the 9-node HEL 54L heterogeneous MIMO run on the 90% text / 10% vision blend.
#
# Intended use from a Cog-synced nb-hel workspace:
#   sbatch examples/mimo/scripts/sbatch_hetero_nemotron_54l_hel_9n_text_vision.sh
...
export RUN_NAME="${RUN_NAME:-mimo54l-hel-9n-text-vision-10-90-gbs${GLOBAL_BATCH_SIZE}}"
