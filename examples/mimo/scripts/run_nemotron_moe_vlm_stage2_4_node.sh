...
# ── Output directories ──────────────────────────────────────────────────────
MODEL_NAME="mimo_vlm_stage2_kevin_ckpt_tp2_ep16"
...
STAGE1_CKPT="${STAGE1_CKPT:-${MEGATRON_ROOT}/logs/mimo_vlm_adapter_only_stage1_kevin_ckpt/checkpoints}"
...
DATA_PATH="${DATA_PATH:-${MEGATRON_ROOT}/examples/mimo/data/omnicorpus_blend.yaml}"
...
# ── Recompute (selective — matches Kevin's config) ───────────────────────────
RECOMPUTE_ARGS=(
...
WANDB_EXP_NAME="${WANDB_EXP_NAME:-mimo-stage2-kevin-ckpt-tp2-ep16}"
