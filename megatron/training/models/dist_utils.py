...
def prepare_existing_model_chunks_for_distributed_training(
    ...
    """Apply the stock post-build distributed lifecycle (TP attrs, GPU, mixed precision, DDP/FSDP)
    to already-built model chunks. Lets non-unimodal builders (e.g. MIMO) reuse the same path."""
