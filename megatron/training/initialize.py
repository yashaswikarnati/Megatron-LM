...
def initialize_megatron(
    ...
    what you are doing.
    Set ``skip_random_seed`` only when model builders seed their child modules
    independently instead of using process-global model-parallel state.
